...
function StatCard({ value, label, tone }: { value: number; label: string; tone: 'blue' | 'orange' | 'red' }) {
  const tones = {
    blue: 'bg-blue-50 text-blue-700 [&_p:last-child]:text-blue-500',
    orange: 'bg-orange-50 text-orange-700 [&_p:last-child]:text-orange-500',
    red: 'bg-red-50 text-red-700 [&_p:last-child]:text-red-500',
  }
  return (
